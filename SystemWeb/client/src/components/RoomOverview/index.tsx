...
function RoomOverview({ roomName, healthPercentage, cpuUsage, alertCount }: RoomOverviewProps) {
    return (
            ...
            <div className="flex flex-col gap-5">
                <div className="flex items-center justify-between text-black">
                    <div className="text-3xl mb-2">
                        ROOM <span className="font-bold bg-[#85CC16] text-white px-3 rounded-md">{roomName}</span>
                    </div>
                ...
                <div className='flex flex-row justify-between items-center text-gray-600 bg-[#DFEDC8] rounded-lg px-4 py-2'>
                    ...
                    <span className='text-red-700 font-bold'>{cpuUsage}%</span>
                </div>
            </div>
        </div>
    );
